...
function getSongList(SongListID) {
    var lid = SongListID;
    $.getJSON(ColudMusicAPI + "/playlist/detail", { id: lid, realIP: '58.250.174.78' }, function (data) {
        ...
        if (l_data.length == 0) {
            ...
            $.getJSON(ColudMusicAPI + "/song/detail", { ids: get_id_list, realIP: '58.250.174.78' }, function (data) {
